function [u_ab, v_ab, na, antennas] = generate_uv_coverage2(T, dl, cov_type, varargin)
...
% To plot antenna positions with labels of the antenna
% labels = cellstr(num2str([1:na]'));
% plot(u(1,:),v(1,:),'*')
% text(u(1,:),v(1,:),labels)
