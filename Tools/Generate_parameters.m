...
% DDES parameters
% -------------------------------------------------------------------------
param_dde.Sd = 1 %5 ; % choose an odd number, DDE of size (Sd x Sd)
param_die.Sd = 1 ;
param_dde.var = 0.05 ;
...
disp('--------------------------------------------')
disp(['number of measurements : ',num2str(param_data.M)])
disp(['number of antennas : ',num2str(param_data.na)])
disp(['number of pairs of antennas : ',num2str(param_data.ant_pair)])
disp(['number of points per antenna pair : ',num2str(param_data.T)])
disp('--------------------------------------------')
% -------------------------------------------------------------------------
