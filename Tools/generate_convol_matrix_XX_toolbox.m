function XX = generate_convol_matrix_XX_toolbox(param_im, param_dde,i)

xhat = reshape(fftshift(reshape(param_im.TF(param_im.x{i}),param_im.Nt)), prod(param_im.Nt),1) ;
