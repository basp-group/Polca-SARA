function [epsilon, param_dual] = updateEpsilon2_stokes(y, y0, epsilon, Jeps, tol_x, n_it, proxEpsilon, B_tmp, Bt_tmp, lambda_scale, L, Lt, M, eta, param_l1,param_pd,x_th, param_dual)
