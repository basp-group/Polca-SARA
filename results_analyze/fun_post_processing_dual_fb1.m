function [x_final,snr] = fun_post_processing_dual_fb1(A_center,A,A_off,seed,im_ch,L_ch)
...
load(['img_dde_const_change_',name,'_new_with_const_method_1.mat'])
%load(['joint_imaging_dde_reg_mod_pdfb_', name2_,'.mat'],'x0');
...
if L_ch == 1 %strcmp(im_choice,'cyg_a')
% For linear feeds
