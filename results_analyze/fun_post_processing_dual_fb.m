function [x_final,snr] = fun_post_processing_dual_fb(A_center,A,A_off,seed,im_ch)
...
load(['joint_imaging_dde_reg_', name2_,'.mat']);
...
[x_final, snr] = update_stokes(y, Jeps, tol_x, nIter, A_est, At_est,L, Lt, M, param_l1.eta_o, param_l1,param_pd,x_th, param_dual, Ax, x, eta_);
 ...
 %%
save(['results/joint_imaging_dde_reg_', name2_,'_post_processing.mat'], 'x_final','eta_o');
