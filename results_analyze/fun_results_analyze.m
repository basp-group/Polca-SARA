...
% algorithm
function[snr_die,snr_final] = fun_results_analyze(im_ch,m_ch,L_ch)
%close all; clear all;
...
na = [];
 ...
 load(['data/synth_data_reg_eusipco_', name,'.mat'],'D_th','F','J','K','N','Omega','P','U_th','V','W','Y','sp_scale','u','v','x_th','y','na');
...
if param_pd.dual_fb == 0
    name_save = sprintf('reg_%s_%s.mat',num2str(im_choice),num2str(A_center),num2str(test_number));
...
'mean_w_resx','mean_w_resxf','mean_w_resxa','mean_w_resxt','mean_w_resxft','mean_w_resxat','Ax','Ax_true','Ax_die','seed');
    ...
    name_fig1 = sprintf('rec_I_reg_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    name_eps1 = sprintf('rec_I_reg_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    
    name_fig2 = sprintf('rec_Q_reg_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    name_eps2 = sprintf('rec_Q_reg_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    
    name_fig3 = sprintf('rec_U_reg_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    name_eps3 = sprintf('rec_U_reg_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    
else
        name_save = sprintf('const_%s_%s.mat',num2str(im_choice),num2str(A_center),num2str(test_number));
...
'mean_w_resx','mean_w_resxf','mean_w_resxa','mean_w_resxt','mean_w_resxft','mean_w_resxat','Ax','Ax_true','Ax_die','seed');
    ...
    name_fig1 = sprintf('rec_I_const_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    name_eps1 = sprintf('rec_I_const_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    
    name_fig2 = sprintf('rec_Q_const_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    name_eps2 = sprintf('rec_Q_const_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    
    name_fig3 = sprintf('rec_U_const_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    name_eps3 = sprintf('rec_U_const_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
end
