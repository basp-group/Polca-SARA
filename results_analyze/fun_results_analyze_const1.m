...
% algorithm
function[snr_die,snr_final] = fun_results_analyze_const1(im_ch,off_ch,L_ch)
%close all; clear all;
...
test_number = 411; %011; 
off_diag = 0;
param_pd.dual_fb = 1; %m_ch; %0: run primal dual to compute prox; 1: run dual forward backward to compute prox
...
if off_ch
 n_tmp_ = ['_new_with_const_method_',num2str(param_pd.dual_fb)];
name2 = [name, n_tmp_];
else
...
load(['results/joint_imaging_dde_reg_mod_pdfb_', name2,'.mat'],'x0');


load(['img_dde_const_change_',name2,'.mat']);

name2_ = [name2, n_tmp];

load(['results/joint_imaging_dde_reg_', name2_,'_post_processing.mat'])
...
seed = 1;
    ...
    if off_ch
    name_save = sprintf('const1_%s_%s.mat',num2str(im_choice),num2str(A_center),num2str(test_number));
    name_fig1 = sprintf('rec_I_const1_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    name_eps1 = sprintf('rec_I_const1_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
                                       
    name_fig2 = sprintf('rec_Q_const1_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    name_eps2 = sprintf('rec_Q_const1_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
                                       
    name_fig3 = sprintf('rec_U_const1_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    name_eps3 = sprintf('rec_U_const1_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    else
                                       
    name_save = sprintf('const1_no_offdiag_%s_%s.mat',num2str(im_choice),num2str(A_center),num2str(test_number));
    name_fig1 = sprintf('rec_I_const1_no_offdiag_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    name_eps1 = sprintf('rec_I_const1_no_offdiag_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
                                       
    name_fig2 = sprintf('rec_Q_const1_no_offdiag_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    name_eps2 = sprintf('rec_Q_const1_no_offdiag_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
                                    
    name_fig3 = sprintf('rec_U_const1_no_offdiag_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
    name_eps3 = sprintf('rec_U_const1_no_offdiag_%s_%s',num2str(im_choice),num2str(A_center),num2str(test_number));
                                       
    end
                                       
                                       
    save(['results_images/saved_files/',name_save],'L','snr_cal','snr_final','x_cal','x_f','res_x','res_xf','res_xtrue','res_xftrue',...
        'w_resx','w_resxf','w_resxt','w_resxft','dr','dr_f','dr_t',...
        'dr_ft','mean_snr_cal','mean_snr_final','mean_dr','mean_dr_f','mean_dr_t','mean_dr_ft',...
        'mean_w_resx','mean_w_resxf','mean_w_resxt','mean_w_resxft','Ax','Ax_true','seed');
